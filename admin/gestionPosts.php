...
<body>
    ...
    <body class="bg-gray-100">
            ...
            <aside class="w-64 bg-gray-900 text-white">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="space-y-1 pl-11" id="analytics-dropdown">
                                ...
                                <a href="gestionPosts.php" class="group flex items-center px-4 py-2 text-sm text-gray-300 rounded-md hover:bg-gray-700 hover:text-white">
                                    Gestionar posts
                                </a>
                ...
                <div class="mt-auto p-4 border-t border-gray-800">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-white"><?php echo $_SESSION['completename']; ?></p>
        ...
        <script src="../assets/js/gestionPost.js"></script>
    </body>
